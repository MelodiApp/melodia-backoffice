...
export const DeleteUserButton = () => {
  ...
  const handleConfirm = () => {
    ...
    console.log('DeleteUserButton: Confirmación de eliminación para usuario:', record.username);
    ...
    deleteOne(
      ...
      {
        onSuccess: () => {
          console.log('DeleteUserButton: Usuario eliminado exitosamente:', record.username);
  ...
  return (
    <>
      ...
      <Dialog open={open} onClose={handleClose}>
        ...
        <DialogContent>
          <DialogContentText>
            ¿Estás segura de que querés eliminar al usuario <strong>{record.username}</strong>?
